...
let projects = [
  {
    image: 'textures/project-airplane.png',
    url: 'https://threejs-plane-with-mountains.vercel.app/',
  },
  {
    image: 'textures/project-christmas.png',
    url: 'https://threejs-christmas-wishes.vercel.app/',
  },
  {
    image: 'textures/project-interface.png',
    url: 'https://dhanushkumar-threejs-portfolio.vercel.app/',
  },
  {
    image: 'textures/project-summary.png',
...
gltfLoader.load(
  ...
  function (room) {
    ...
    video.src = 'textures/anonymous.webm';
    video.muted = true;
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('WHITE DEVIL', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
